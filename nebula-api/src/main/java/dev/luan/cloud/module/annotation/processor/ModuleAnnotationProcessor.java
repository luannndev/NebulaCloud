package dev.luan.cloud.module.annotation.processor;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.google.gson.JsonObject;
import dev.luan.cloud.module.annotation.Module;
...
@SupportedAnnotationTypes({"dev.luan.cloud.module.annotation.Module"})
        ...
        for (Element element : roundEnv.getElementsAnnotatedWith(Module.class)) {
            ...
            try {
                FileObject object = environment.getFiler()
                        .createResource(StandardLocation.CLASS_OUTPUT, "", "nebula-info.json");
                ...
                environment.getMessager()
                        .printMessage(Diagnostic.Kind.ERROR, "Unable to generate nebula-info.json file");
            }
        }
